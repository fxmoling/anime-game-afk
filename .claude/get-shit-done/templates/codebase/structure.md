...
- Usage: Reference from command with `@c:/Users/Administrator/Desktop/anime-game-afk/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to c:/Users/Administrator/Desktop/anime-game-afk/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to c:/Users/Administrator/Desktop/anime-game-afk/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
