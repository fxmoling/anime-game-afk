...
- **Global scope**: `c:/Users/Administrator/Desktop/anime-game-afk/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `c:/Users/Administrator/Desktop/anime-game-afk/.claude/notes/`)
...
2. Glob `c:/Users/Administrator/Desktop/anime-game-afk/.claude/notes/*.md` (if directory exists) — global notes
...
Global (c:/Users/Administrator/Desktop/anime-game-afk/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `c:/Users/Administrator/Desktop/anime-game-afk/.claude/notes/` — works in any directory
